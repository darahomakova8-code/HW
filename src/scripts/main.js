import { hotels, bookings } from './moduls/data.js';
import { enableForm, restoreFooter } from './moduls/domUtils.js';
import { validateEmail, showNotification, initSubscription, setupFaqDropdown, setupGallery } from './moduls/utils.js';
