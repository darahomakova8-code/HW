...
})({"99Vd8":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7a390d5999e125bc";
"use strict";
...
},{}],"8Ul7Q":[function(require,module,exports,__globalThis) {
var _data3Js = require("./moduls/data3.js");
var _domUtils3Js = require("./moduls/domUtils3.js");
var _utils3Js = require("./moduls/utils3.js");
var _localStorageJs = require("./moduls/local-storage.js");
function setupAutoSave() {
    if (!(0, _localStorageJs.isStorageSupported)()) {
    ...
    document.querySelectorAll('input').forEach((input)=>{
        input.addEventListener('input', ()=>{
            ...
            input._saveTimer = setTimeout(()=>{
                (0, _localStorageJs.saveFormToStorage)();
...
function restoreForm() {
    if (!(0, _localStorageJs.isStorageSupported)()) return;
    setTimeout(()=>{
        const restored = (0, _localStorageJs.loadFormFromStorage)();
        if (restored) {
            ...
            setTimeout(()=>{
                if (restoreNotice.parentNode) restoreNotice.remove();
            }, 3000);
        }
    }, 100);
}
function togglePaymentFields() {
    ...
    if (creditCardOption && cardFields) cardFields.style.display = creditCardOption.checked ? 'block' : 'none';
    if ((0, _localStorageJs.isStorageSupported)()) (0, _localStorageJs.saveFormToStorage)();
}
function updateOrderSummary() {
    const totalElement = document.querySelector('.breakdown-total span:last-child');
    if (totalElement) {
        const subtotal = (0, _data3Js.checkoutData).cart.reduce((sum, item)=>sum + item.price * item.quantity, 0);
...
function validateForm() {
    ...
    for (let field of requiredFields)if (!field?.trim()) {
        (0, _utils3Js.showNotification)('Please fill in all required fields', 'error');
        return false;
    }
    ...
    if (isCreditCard) {
        ...
        if (cardNumber.replace(/\s/g, '').length !== 16) {
            (0, _utils3Js.showNotification)('Please enter a valid 16-digit card number', 'error');
            return false;
        }
    }
    return true;
...
function handleCompleteBooking(e) {
    ...
    (0, _utils3Js.showNotification)(`Order #${order.id} confirmed! Total: $${order.total.toFixed(2)}`, 'success');
    if ((0, _localStorageJs.isStorageSupported)()) (0, _localStorageJs.clearFormStorage)();
    (0, _data3Js.orderHistory).push(order);
...
function initCheckoutPage() {
    ...
    if (!(0, _localStorageJs.isStorageSupported)()) (0, _utils3Js.showNotification)('Note: Form data will not be saved if you refresh the page', 'info');
    setupAutoSave();
    restoreForm();
    document.querySelectorAll('input[name="payment"]').forEach((radio)=>{
    ...
    if (cardNumberInput) cardNumberInput.addEventListener('input', (0, _utils3Js.formatCardNumber));
    const expDateInput = document.querySelector('input[placeholder="MM/YY"]');
    if (expDateInput) expDateInput.addEventListener('input', (0, _utils3Js.formatExpDate));
    const completeBtn = document.querySelector('.complete-booking-btn');
    if (completeBtn) completeBtn.addEventListener('click', handleCompleteBooking);
    updateOrderSummary();
...
if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', initCheckoutPage);
else initCheckoutPage();

},{"./moduls/data3.js":"1F0oI","./moduls/domUtils3.js":"heZM6","./moduls/utils3.js":"9JCm9","./moduls/local-storage.js":"99meQ"}],"1F0oI":[function(require,module,exports,__globalThis) {
...
},{"./data3.js":"1F0oI","@parcel/transformer-js/src/esmodule-helpers.js":"2iRUY"}],"99meQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isStorageSupported", ()=>isStorageSupported);
parcelHelpers.export(exports, "saveFormToStorage", ()=>saveFormToStorage);
parcelHelpers.export(exports, "loadFormFromStorage", ()=>loadFormFromStorage);
parcelHelpers.export(exports, "clearFormStorage", ()=>clearFormStorage);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2iRUY"}]},["99Vd8","8Ul7Q"], "8Ul7Q", "parcelRequireb5ae", {})

//# sourceMappingURL=index25.99e125bc.js.map
